/*
 jQuery jPList Plugin 3.1.0.349 
...
a,b,c,f,e){for(var h,i,m=[],n=0;n<f.length;n++)h=f[n],i=h.find_pathitem(c),null!=i&&(null==d||void 0==d||""==d||null==a||void 0==a||""==a||null==b||void 0==b||""==b?m.push(h):(i=jQuery.fn.jplist.sort.format_datetime(i.text,e),null!=i&&void 0!=i&&"function"===typeof i.getFullYear&&i.getFullYear()==d&&i.getMonth()-1==a&&i.getDate()==b&&m.push(h)));return m};jQuery.fn.jplist.filters.pager_filter=function(d,a){var b=[];return b=a.slice(d.start,d.end)};jQuery.fn.jplist.filters.range_filter=function(d,
